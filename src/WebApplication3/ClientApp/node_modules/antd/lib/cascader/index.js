...
var Cascader = function (_React$Component) {
    ...
    function Cascader(props) {
        ...
        _this.renderCascader = function (_ref, locale) {
            ...
            var clearIcon = allowClear && !disabled && value.length > 0 || state.inputValue ? React.createElement(_icon2['default'], { type: 'close-circle', theme: 'filled', className: prefixCls + '-picker-clear', onClick: _this.clearSelection }) : null;
            ...
            return React.createElement(
                ...
                (0, _extends3['default'])({}, rest, { getPopupContainer: getPopupContainer, options: options, value: value, popupVisible: state.popupVisible, onPopupVisibleChange: _this.handlePopupVisibleChange, onChange: _this.handleChange, dropdownMenuColumnStyle: dropdownMenuColumnStyle, expandIcon: expandIcon, loadingIcon: loadingIcon }),
                input
            );
        };
        _this.state = {
            ...
            if (filtered.length > 0) {
                return filtered.map(function (path) {
                    ...
                    return _ref2 = {
                        ...
                        path: path
                    }, (0, _defineProperty3['default'])(_ref2, names.label, render(inputValue, path, prefixCls, names)), (0, _defineProperty3['default'])(_ref2, names.value, path.map(function (o) {
                        return o[names.value];
                    })), (0, _defineProperty3['default'])(_ref2, 'disabled', path.some(function (o) {
                        return !!o.disabled;
                    })), _ref2;
                });
            }
            return [(_ref3 = {}, (0, _defineProperty3['default'])(_ref3, names.label, notFoundContent), (0, _defineProperty3['default'])(_ref3, names.value, 'ANT_CASCADER_NOT_FOUND'), (0, _defineProperty3['default'])(_ref3, 'disabled', true), _ref3)];
        }
    }, {
        key: 'focus',
