...
var Tooltip = function (_React$Component) {
    ...
    function Tooltip(props) {
        ...
        _this.renderTooltip = function (_ref) {
            ...
            var child = _this.getDisabledCompatibleChildren(React.isValidElement(children) ? children : React.createElement(
                'span',
                null,
                children
            ));
            ...
            return React.createElement(
                _rcTooltip2['default'],
                (0, _extends3['default'])({}, _this.props, { getTooltipContainer: getPopupContainer || getTooltipContainer || getContextPopupContainer, ref: _this.saveTooltip, builtinPlacements: _this.getPlacements(), overlay: overlay || title || '', visible: visible, onVisibleChange: _this.onVisibleChange, onPopupAlign: _this.onPopupAlign }),
