...
var InputNumber = function (_React$Component) {
    ...
    (0, _createClass3['default'])(InputNumber, [{
        ...
        value: function render() {
            ...
            var upIcon = React.createElement(_icon2['default'], { type: 'up', className: this.props.prefixCls + '-handler-up-inner' });
            var downIcon = React.createElement(_icon2['default'], { type: 'down', className: this.props.prefixCls + '-handler-down-inner' });
