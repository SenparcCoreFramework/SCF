...
var FilterMenu = function (_React$Component) {
    ...
    function FilterMenu(props) {
        ...
        _this.renderFilterIcon = function () {
            ...
            var dropdownIconClass = (0, _classnames2['default'])((_classNames = {}, (0, _defineProperty3['default'])(_classNames, prefixCls + '-selected', filtered), (0, _defineProperty3['default'])(_classNames, prefixCls + '-open', _this.getDropdownVisible()), _classNames));
    ...
    (0, _createClass3['default'])(FilterMenu, [{
        ...
        value: function renderMenuItem(item) {
            ...
            var input = multiple ? React.createElement(_checkbox2['default'], { checked: selectedKeys && selectedKeys.indexOf(item.value.toString()) >= 0 }) : React.createElement(_radio2['default'], { checked: selectedKeys && selectedKeys.indexOf(item.value.toString()) >= 0 });
