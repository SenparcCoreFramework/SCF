    ...
    (0, _createClass3['default'])(Search, [{
        ...
        value: function render() {
            ...
            var icon = value && value.length > 0 ? React.createElement(
                ...
                React.createElement(_icon2['default'], { type: 'close-circle', theme: 'filled' })
            ) : React.createElement(
                'span',
            ...
            return React.createElement(
                'div',
                null,
                React.createElement(_input2['default'], { placeholder: placeholder, className: prefixCls, value: value, ref: 'input', onChange: this.handleChange, disabled: disabled }),
                icon
            );
        }
    }]);
