            ...
            var list = items.map(function (file) {
                ...
                if (listType === 'picture' || listType === 'picture-card') {
                    if (listType === 'picture-card' && file.status === 'uploading') {
                        ...
                        icon = React.createElement(Icon, { className: prefixCls + '-list-item-thumbnail', type: 'picture', theme: 'twoTone' });
                    } else {
                        var thumbnail = isImageUrl(file) ? React.createElement('img', { src: file.thumbUrl || file.url, alt: file.name }) : React.createElement(Icon, { type: 'file', className: prefixCls + '-list-item-icon', theme: 'twoTone' });
                        icon = React.createElement(
                            'a',
