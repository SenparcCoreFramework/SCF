...
{
    public interface ISqlMyAppFinanceData : ISqlBaseFinanceData
    {
        MySenparcEntities DataContext { get; }
    }

    //[Pluggable("ClientDatabase")]
    public class SqlMyAppFinanceData : SqlBaseFinanceData, ISqlBaseFinanceData, ISqlMyAppFinanceData
    {
        private MySenparcEntities dataContext;

        public SqlMyAppFinanceData(MySenparcEntities senparcEntities)
        {
        ...
        public MySenparcEntities DataContext
        {
            get
            {
                return BaseDataContext as MySenparcEntities;
            }
        }
        ...
        public override DbContext BaseDataContext
        {
            get
            {
                if (dataContext == null)
                {
                    //var connectionString = Scf.Core.Config.SenparcDatabaseConfigs.ClientConnectionString;
